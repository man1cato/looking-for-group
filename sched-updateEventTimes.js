...
const updateEventTimes = () => {
    ...
    // const eventsResponse = await axios.get(`${baseUrl}/Events?api_key=${apiKey}&view=Update Datetime Feed`);
    // const events = eventsResponse.data.records;
        ...
        function page(records, fetchNextPage) {
            records.forEach((event) => {
                ...
                getStartDatetime(availabilityId, timezoneId).then((startDatetime) => {  //GET START DATETIME
                    ...
                    axios.post(`${groupmeBaseUrl}/groups/${groupId}/messages?access_token=${groupmeAccessToken}`, {       //SEND NEW DATE & TIME MESSAGE TO GROUP CHAT
                        "message": {
