//THIS SHOULD RUN DAILY - STILL NEED TO FIGURE THIS OUT
...
export default async (group, area) => {
...
const createEvent = async (groupRecordId, startDatetime, availabilityRecordId) => {
